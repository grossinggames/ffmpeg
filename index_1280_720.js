...
(async function() {
    ...
    for (const item of firstFrames) {
        ...
        await new Promise((resolve) => {
            ...
            exec('ffmpeg -f image2 -r 25 -i ./' + itemArray[0] + '/' + itemArray[1] + '/' + pattern + ' -s 1280x720 -b:v 3.5M -pix_fmt yuv420p -y -an -r 25 -vcodec h264 ./video/' + itemArray[1] + '.mp4', (err, stdout, stderr) => {
                if (err) {
                    console.error(err);
                }
